...
```bash
codex-session-tui copy <session-id> user@remote:/home/user/data/cases
...
codex-session-tui ls user@remote
codex-session-tui ls user@remote:/home/user/data/cases
codex-session-tui repair-index
codex-session-tui repair-index user@remote
```
...
- a machine-qualified path, for example `pi:/home/user/work/repo`
...
- `copy` is for "same chat, second location". If you copy a session from `local:/home/user/gh/app` to `pi:/home/user/gh/app`, the duplicate carries the same conversation history into the remote folder as another copy of that chat.
...
```bash
codex-session-tui copy 019aee85-21cf-78a2-9a65-5286d2f341b6 user@remote:/home/user/data/cases
codex-session-tui move 019aee85-21cf-78a2-9a65-5286d2f341b6 /home/user/data/cases-debug
```
...
- drag a local chat into `pi:/home/user/work/repo`
...
- drag `git` onto `pi:/home/user/work` -> sessions land under `pi:/home/user/work/git/...`
- rename grouped `/root` to `/home/user` -> sessions land under `/home/user/...` rather than `/home/user/root/...`
